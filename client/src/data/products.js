...
export const products = [
  ...
  {
    id: 'native-agbada-outercape',
    slug: 'signature-agbada',
    name: 'Signature Agbada Outer Cape',
    category: 'native-wear',
    price: 210000,
    description:
      'The outer cape centrepiece of Nigerian menswear. Deep, structured embroidery across the chest and a dramatic flowing silhouette. Worn over a matching kaftan.',
    details: {
      embroidery: 'Layered chest embroidery with dimensional thread work',
      neckline: 'V-open neckline with embroidered lapel edge',
      pocket: 'Flapped chest pockets with detailed stitching',
      fabric: 'Rich silk-blend brocade',
      sleeve: 'Wide ceremonial sleeve openings',
      custom: 'Can be paired with any Grandeur kaftan',
    },
    sizes: ['L', 'XL', 'XXL'],
    colors: ['Deep Burgundy', 'Charcoal', 'Forest Green'],
    stock: 12,
    featured: true,
    image: u('photo-1507003211169-0a1dd7228f2d'),
    detailImages: [u('photo-1507003211169-0a1dd7228f2d'), u('photo-1558769132-94e457f0e3af')],
  },
  {
    id: 'suit-linen-slim',
    slug: 'two-piece-suit',
  ...
  {
    id: 'native-casual-kaftan',
    slug: 'casual-kaftan',
    name: 'Casual Daily Kaftan',
    category: 'native-wear',
    price: 65000,
    description:
      'An easy-going everyday kaftan with a relaxed fit, minimal detailing and a soft collar. Luxury comfort that still carries the Grandeur cut.',
    details: {
      embroidery: 'Fine tonal stitching on collar and cuff',
      neckline: 'Soft spread collar',
      pocket: 'Single chest pocket',
      fabric: 'Breathable premium cotton',
      sleeve: 'Relaxed set-in sleeve with cuff',
      custom: 'Length and fit adjustable at order',
    },
    sizes: ['M', 'L', 'XL', 'XXL'],
    colors: ['Cream', 'Chocolate', 'Grey'],
    stock: 40,
    featured: false,
    image: u('photo-1618354691373-d851c5c3a990', 900),
    detailImages: [u('photo-1618354691373-d851c5c3a990')],
  },
  {
    id: 'casual-polo-knit',
    slug: 'luxury-polo',
